...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('android_core_path', null,
                    $modx->getOption('core_path') . 'components/android/') . 'model/';
            $modx->addPackage('android', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/android/model/schema/android.mysql.schema.xml';
